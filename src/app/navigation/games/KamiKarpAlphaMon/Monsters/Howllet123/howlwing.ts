...
// BODY
// =========================
function drawHowlwingBody({ ctx, x, y, time, scale }: MonsterBodyDrawArgs) {
  ...
  const headRows = [
    ...
    ".....OBBBLLLLLLLLLBBBO.....",
    "....OBBBBLLLLLLLLLBBBBO....",
    "...OBBBBLLLLLHHLLLLBBBBO...",
    "..OBBBBLLLHHHHHHHLLLBBBBO..",
    "..OBBBBLLHHHHHHHHHLLBBBBO..",
    "..OBBBBLLHHHHHHHHHLLBBBBO..",
    "..OBBBBLLHHHHHHHHHLLBBBBO..",
    "...OBBBBLLLHHHHHHLLLBBBBO..",
    "...OBBBBBLLLLHHHLLLBBBBBO..",
  ...
  const bodyRows = [
    ...
    "..........OBBBBLLLLBBBBBBO.........",
    ".........OBBBBLLLLLLLLBBBBO........",
    "........OBBBLLLLLLLLLLLLBBBO.......",
    "........OBBBLLLLLLLLLLLLBBBO.......",
    "........OBBBLLLLGGGGLLLLBBBO.......",
    "........OBBBLLLGGGGGGLLLBBBO.......",
    "........OBBBLLGGGGGGGGLLBBBO.......",
    "........OBBBLLGGGGGGGGLLBBBO.......",
    "........OBBBLLGGGGGGGGLLBBBO.......",
    "........OBBBLLLGGGGGGLLLBBBO.......",
    "........OBBBLLLLGGGGLLLLBBBO.......",
...
const wingRows = buildWingRows(wingFrame);
  ...
  if (tailFrame === 0) {
    tailRows = [
      ...
      "................SSSCCCCAAAAAAAOOO......",
      "............SSSCCCCAAAAAAAAAAOO........",
      ".........SSSCCCCAAAAAAAAAAACOO.........",
      "......SSSCCCAAAAAAAAAAAAACOO...........",
      ".....SSCCAAAAAAAAAAAAAACOO.............",
      "......SCCAAAAAAAAAAAACOO...............",
      ".......SSCCAAAAAAAACOO.................",
      ".........SSCCCCCCOO....................",
    ];
  ...
  // main body first so wings sit at sides/front

  
  
  drawPixelBlock(ctx, bodyRows, palette, -3, 18, pixelSize); 
   drawPixelBlock(ctx, footRows, palette, 2, 35, pixelSize);
  drawPixelBlock(ctx, wingRows, palette, -17, 19, pixelSize);
  drawPixelBlock(ctx, crestRows, palette, -2, -3, pixelSize);
  drawPixelBlock(ctx, headRows, palette,2, 5, pixelSize);


  const blink = Math.sin(time * 4.2) > 0.955;
  ...
  // air glow accents
  if (Math.sin(time * 2.4) > 0.1) {
    px(ctx, -2, 29, 1, 1, palette.S, pixelSize);
    px(ctx, 2, 31, 1, 1, palette.C, pixelSize);
    px(ctx, 0, 34, 1, 1, palette.A, pixelSize);
  }
...
// FACE
// =========================
function drawHowlwingFace(
  _state: MonsterDrawArgs["state"],
  _args: FaceDrawArgs
) {
  // face drawn directly in body for pixel version
}

// =========================
// EXPORT
// =========================
export const howlwingMonster: MonsterDefinition = {
  id: "HOWLWING",
  name: "Howlwing",
  imageSrc: "",
  baseHeight: 230,
  ...
  battleOffsetX: 0,
  battleOffsetY: 245,
  drawBody: drawHowlwingBody,
  drawFace: drawHowlwingFace,
};